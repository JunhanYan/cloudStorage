			...
			<div>
                <div class="page-title control-navbar">
                	<div id="toolbar" class="title-env">
                       <button id="delete-button"class="btn btn-turquoise">删除</button>
                       <button id="restore-button"class="btn btn-orange">还原</button>
...
//		main("resourceController/getResourcesByType/doc-");
		...
		main("getTrashResource/");
		
		$("#restore-button").click(function (e) {
			e.preventDefault();
			checkBoxHandler(0, "getTrashResource/");
		});

		$("#delete-button").click(function (e) {
			e.preventDefault();
			checkBoxHandler(-1, "getTrashResource/");
		});
