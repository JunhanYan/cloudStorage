			...
			<div class="col-sm-6">
				...
				<div class="errors-container">
					...
					<div class="form-group">
						<label class="control-label" for="username">Useraccount</label>
						<input type="text" class="form-control input-dark" name="useraccount" id="userAccount" autocomplete="off" />
					</div>
					
					<div class="form-group">
						<label class="control-label" for="useraccount=">Username</label>
					...
					<div class="form-group">
						<label class="control-label" for="passwd2">Password again</label>
				...
				<div class="external-login">
					...
					<a onclick = "register(); return false;" href="#" class="twitter">
