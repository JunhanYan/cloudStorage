...
<body class="page-body">
	...
	<div class="page-container">
						...
						<div class="row">
							<div class="col-sm-6">
								...
								<table class="table table-hover">
									<thead>
										<tr>
											<th style="display: none">followid</th>
											<th>关注我的</th>
										</tr>
									</thead>
									<tbody id="follow-template">
	    ...
	    $("#navbar #right-links [data-type='username']").html(username);
			...
			{
				$.ajax({
		            url: 'http://172.31.34.180/littleVCloud/followController/getWho/'+userid+'.do',
		            dataType: 'json',
		            method: 'GET',
		            ...
		            .success(function (datas, status, headers, config) {
		            	var content = "";
		            	$("#follow-template").html(content);//清空缓存
						if(datas.length > 0){
