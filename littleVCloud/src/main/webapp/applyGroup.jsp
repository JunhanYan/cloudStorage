...
<body class="page-body">
	...
	<div class="page-container">
				...
				<div class="col-md-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">申请入组</h3>
						
							<div class="panel-options">
							<input type="text" id="search" placeholder="Type to search..." />
							<a href="javascript:searchTeam()">
								<i class="linecons-search"></i>
							</a>	
	    ...
	    $("#navbar #right-links [data-type='username']").html(username);
			...
			{
				$.ajax({
		            url: 'http://172.31.34.180/littleVCloud/teamController/getAllTeams.do',
		            dataType: 'json',
		            method: 'GET',
		            ...
		            .success(function (datas, status, headers, config) {
						...
						if(datas.length > 0){
							$.each(datas, function(i, data){
								var isIn = false;
								$.ajax({
									url: 'http://172.31.34.180/littleVCloud/teamController/getTeamMembers/'+data.teamId+'.do',
						            dataType: 'json',
						            method: 'GET',
						            contentType:'application/json;charset=UTF-8'
						            ...
						            if(isIn){
									     content +="<tr><th> <a>" + data.teamName+"</a></th><th><span>已加入</span></th> <th><a href='javascript: quitGroup("+userid+","+data.teamId+")'>退出该群</a></th></tr>";
									}else{
									       content +="<tr><th> <a>" + data.teamName+"</a></th><th><a href='javascript: applyGroup("+userid+","+data.teamId+")'>申请</a></th> </tr>";
									}
			...
			function quitGroup(uid, tid){
				$.ajax({
					url: 'http://172.31.34.180/littleVCloud/teamController/deleteUserFromTeam/'+uid+'-'+tid+'.do',
					dataType: 'json',
					method: 'DELETE',
					contentType:'application/json;charset=UTF-8'
				})
			...
			function searchTeam(){
				...
				$.ajax({
					url:'http://172.31.34.180/littleVCloud/teamController/getTeamsByName/'+team+'.do',
					dataType: 'json',
		            method: 'GET',
		            contentType:'application/json;charset=UTF-8'
				})
				.success(function (datas, status, headers, config) {
					var content = "";
	            	$("#search-template").html(content);//清空缓存
	            	if(datas!=null){
						$.each(datas, function(i, data){ 
